class Livre:
    ...
    def __init__(self, auteur, titre, ane, genre):
        raise NotImplementedError("Les instances de la classe Livre ne peuvent pas être créées directement")
...
class LivreIllustre(Livre):

    def __init__(self, auteur, titre, ane, genre, illustrateur):
        super().__init__(auteur, titre, ane, genre)
        self.__illustrateur = illustrateur

    def lecture(self):
        return "Ce livre illustre peut être lu et regardé"

    def get_illustrateur(self):
        return self.__illustrateur

    def set_illustrateur(self, illustrateur):
        self.__illustrateur = illustrateur


class LivreAudio(Livre):

    def __init__(self, auteur, titre, ane, genre, narrateur):
        super().__init__(auteur, titre, ane, genre)
        self.__narrateur = narrateur

    def lecture(self):
        return "Ce livre audio peut être lu et écouté"

    def get_narrateur(self):
        return self.__narrateur

    def set_narrateur(self, narrateur):
        self.__narrateur = narrateur
